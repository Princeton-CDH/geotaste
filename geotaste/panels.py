...
class ComparisonPanel(BaseComponent):
    ...
    @cached_property
    def store_json(self):
        """Stores the JSON data for the graph drawing in a Dash Core Component Store.
    ...
    def layout(self, params=None):
        ...
        Args:
            params (dict, optional): Parameters passed for querystring
        
        Returns:
            dbc.Container: The layout container.
        """
        ...
        return dbc.Container([
            ...
            dbc.Container([
                # self.mainview_tabs,   # <- this is now in the GeotasteLayout
                self.mainview,
                self.store,
                self.store_json,
                self.table_json,
...
class FilterPanel(FilterCard):
    """A class used to represent a Filter Panel that interacts with the Filter Card"""

    unfiltered = UNFILTERED

    def describe_filters(self, panel_data):
        """Method used to describe the filters with the given panel data
        
        Args: 
            panel_data (dict): dictionary that represents panel data
    ...
    def component_callbacks(self, app):
        """Method used to implement the component callbacks for the panel
...
class MemberPanel(FilterPanel):
    """A class used to represent a Member Panel that inherits the properties of the Filter Panel"""
    ...
    @cached_property
    def name_card(self): 
        """Property method to represent a Member Name Card
        
        Returns:
            MemberNameCard: The member name card object
        """
        return MemberNameCard(name_context=self.name, **self._kwargs)

        
    # [Other similar cached_property methods here...]
    
    
# [Rest of the classes here...]
